...
namespace Chess {
    ...
    static constexpr uint8_t PAWN_INIT_POSITION[2] = { 1, 6 };
    static constexpr uint8_t OTHER_PIECE_INIT_POSITION[2] = { 0, 7 };
    ...
    struct Piece {
        ...
        : m_Name(name), m_Color(color), m_X(x), m_Y(y) {}
    ...
    private:
        ...
        PieceTexture m_TileIconTexture;
    };
